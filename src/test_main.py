...
from main import fetch_schedule, fetch_instructors, format_schedule, get_reservation_emoji, bot
...
class TestMain(unittest.TestCase):
    ...
    def test_fetch_schedule(self, mock_get):
        ...
        mock_response.json.return_value = {
            'data': {
                'studio_lessons': {
                    'items': [
                        {'id': 1, 'instructor_id': 1, 'start_at': '2023-10-01T10:00:00', 'end_at': '2023-10-01T11:00:00', 'date': '2023-10-01', 'reservation_count': 2}
                    ]
                }
            }
        }
    ...
    def test_format_schedule(self):
        items = [
            {'instructor_id': 1, 'start_at': '2023-10-01T10:00:00', 'end_at': '2023-10-01T11:00:00', 'date': '2023-10-01', 'reservation_count': 2}
        ]
